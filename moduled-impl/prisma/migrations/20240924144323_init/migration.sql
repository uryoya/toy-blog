...
-- CreateTable
CREATE TABLE "ArticleCreated" (
    "articleId" UUID NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "ArticleCreated_pkey" PRIMARY KEY ("articleId")
);
...
-- AddForeignKey
ALTER TABLE "ArticleCreated" ADD CONSTRAINT "ArticleCreated_articleId_fkey" FOREIGN KEY ("articleId") REFERENCES "Article"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
